...
const adapter = (config) => {
  return new Promise((resolve2, reject) => {
    ...
    if (config.method === "UPLOAD") {
      ...
      requestTask = index.downloadFile(_config);
    } else {
      const optionalKeys = [
        "data",
        "method",
...
(function(module2, exports2) {
  !function(t2, e2) {
    ...
    var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i2 = "second", s2 = "minute", u2 = "hour", a2 = "day", o2 = "week", f2 = "month", h2 = "quarter", c2 = "year", d2 = "date", l2 = "Invalid Date", $2 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M2 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
    ...
    var _2 = function() {
      ...
      return m3.parse = function(t3) {
        ...
        var $3, y2 = O2.p(d3), M4 = w2(r3), m4 = (M4.utcOffset() - this.utcOffset()) * e2, v3 = this - M4, g3 = O2.m(this, M4);
        return g3 = ($3 = {}, $3[c2] = g3 / 12, $3[f2] = g3, $3[h2] = g3 / 3, $3[o2] = (v3 - m4) / 6048e5, $3[a2] = (v3 - m4) / 864e5, $3[u2] = v3 / n2, $3[s2] = v3 / e2, $3[i2] = v3 / t2, $3)[y2] || v3, l3 ? g3 : O2.a(g3);
  ...
  list: [
    {
      ...
      selectedIconPath: "static/tabbar/indexFilled.png",
      text: "\u8BB0\u8D26"
    },
    {
      pagePath: "pages/statistics/index",
      iconPath: "static/tabbar/static.png",
      selectedIconPath: "static/tabbar/staticFilled.png",
      text: "\u7EDF\u8BA1"
    },
    {
      pagePath: "pages/my/index",
      iconPath: "static/tabbar/my2.png",
      selectedIconPath: "static/tabbar/my2Filled.png",
      text: "\u6211\u7684"
    }
  ]
};
...
function rs({ api: e2, redirect: t2 } = {}) {
  ...
  es ? "navigateTo" !== e2 && "redirectTo" !== e2 || (e2 = "switchTab") : "switchTab" === e2 && (e2 = "navigateTo"), setTimeout(() => {
    index[e2]({ url: n2 });
  });
}
function is({ url: e2 } = {}) {
