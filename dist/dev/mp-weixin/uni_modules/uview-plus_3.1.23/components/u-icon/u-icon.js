...
const uni_modules_uviewPlus_3_1_23_components_uIcon_icons = require("./icons.js");
const uni_modules_uviewPlus_3_1_23_components_uIcon_props = require("./props.js");
...
const _sfc_main = {
  ...
  emits: ["click"],
  mixins: [uni_modules_uviewPlus_3_1_23_libs_mixin_mpMixin.mpMixin, uni_modules_uviewPlus_3_1_23_libs_mixin_mixin.mixin, uni_modules_uviewPlus_3_1_23_components_uIcon_props.props],
  computed: {
    uClasses() {
      let classes = [];
    ...
    icon() {
      return uni_modules_uviewPlus_3_1_23_components_uIcon_icons.icons["uicon-" + this.name] || this.name;
    }
  },
  methods: {
    clickHandler(e) {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-120f4cb9"], ["__file", "D:/uni-css/src/uni_modules/uview-plus_3.1.23/components/u-icon/u-icon.vue"]]);
